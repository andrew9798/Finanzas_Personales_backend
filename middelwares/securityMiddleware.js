...
export const securityHeaders = helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            fontSrc: ["'self'"],
            imgSrc: ["'self'", "data:"],
            connectSrc: ["'self'", "http://localhost:1234"], // Permite explícitamente a tu API            frameSrc:                ["'none'"],
            objectSrc: ["'none'"],
    ...
    crossOriginResourcePolicy: { policy: 'cross-origin' },   // Recursos solo accesibles desde tu origin
